...
void clustr ( double (&x)[DATASIZE], double (&d)[CLUSTERS], double (&dev)[CLUSTERS], int (&b)[DATASIZE], double (&f)[DATASIZE], 
  int (&e)[CLUSTERS], int i = DATASIZE, int j = 1, int n = CLUSTERS, int nz = 10, int k = CLUSTERS )
